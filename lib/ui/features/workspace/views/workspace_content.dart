  ...
  Widget build(BuildContext context) {
    return CallbackShortcuts(
      bindings: {
        ...
        const SingleActivator(LogicalKeyboardKey.keyZ, control: true): _controller.undoEdit,
        const SingleActivator(LogicalKeyboardKey.keyY, control: true): _controller.redoEdit,
      },
      child: Focus(
        autofocus: true,
