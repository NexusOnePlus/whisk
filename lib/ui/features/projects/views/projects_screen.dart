            ...
            Row(
              children: [
                WorkspaceRail(
                  ...
                  onHome: widget.onBackToWorkspace,
                ),
                Expanded(
                  child: Padding(
    ...
    showMenu<String>(
      ...
      items: [
        ...
        PopupMenuItem(
          ...
          child: Row(
            children: [
              const Icon(Icons.label_outline, size: 16, color: kTextSecondary),
              const SizedBox(width: 8),
              const Text('Add tag', style: TextStyle(color: kTextPrimary, fontSize: 13)),
            ],
          ),
        ),
        PopupMenuItem(
          ...
          FilledButton(
            onPressed: () {
              if (controller.text.trim().isNotEmpty) {
                widget.onAddTag?.call(controller.text.trim());
                Navigator.of(context).pop();
              }
            },
